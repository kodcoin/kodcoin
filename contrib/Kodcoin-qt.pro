...
RESOURCES += src/qt/Kodcoin.qrc src/qt/Kodcoin_locale.qrc

TRANSLATIONS += src/qt/locale/Kodcoin_bg.ts \
                src/qt/locale/Kodcoin_de.ts \
                src/qt/locale/Kodcoin_en.ts \
                src/qt/locale/Kodcoin_es.ts \
                src/qt/locale/Kodcoin_fi.ts \
                src/qt/locale/Kodcoin_fr.ts \
                src/qt/locale/Kodcoin_it.ts \
                src/qt/locale/Kodcoin_ja.ts \
                src/qt/locale/Kodcoin_pl.ts \
                src/qt/locale/Kodcoin_pt.ts \
                src/qt/locale/Kodcoin_ru.ts \
                src/qt/locale/Kodcoin_sk.ts \
                src/qt/locale/Kodcoin_sv.ts \
                src/qt/locale/Kodcoin_vi.ts \
                src/qt/locale/Kodcoin_zh_CN.ts \
                src/qt/locale/Kodcoin_zh_TW.ts
