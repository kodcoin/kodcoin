...
In order to support loading of multiple wallets in Kodcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Kodcoin.cpp.
...
Changes to Kodcoin.cpp
----------------------
Kodcoin.cpp is the entry point into Kodcoin-qt, and as such, will require some minor modifications to provide hooks for
