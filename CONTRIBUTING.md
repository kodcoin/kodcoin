Contributing to Kodcoin Core
============================

The Kodcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Kodcoin Core project, and is not to be
confused with overall Kodcoin Network Protocol consensus changes.

Whether a pull request is merged into Kodcoin Core rests with the project merge
...
Patches that change Kodcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Kodcoin consensus, it must have been
...
The project leader is the release manager for each Kodcoin Core release.
