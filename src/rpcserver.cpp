...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Kodcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Kodcoin features */
        {"Kodcoin", "masternode", &masternode, true, true, false},
        {"Kodcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"Kodcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"Kodcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"Kodcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"Kodcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"Kodcoin", "startmasternode", &startmasternode, true, true, false},
        {"Kodcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"Kodcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"Kodcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"Kodcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"Kodcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"Kodcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"Kodcoin", "mnbudget", &mnbudget, true, true, false},
        {"Kodcoin", "preparebudget", &preparebudget, true, true, false},
        {"Kodcoin", "submitbudget", &submitbudget, true, true, false},
        {"Kodcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"Kodcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"Kodcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"Kodcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"Kodcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"Kodcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"Kodcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"Kodcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"Kodcoin", "mnsync", &mnsync, true, true, false},
        {"Kodcoin", "spork", &spork, true, true, false},
        {"Kodcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"Kodcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use Kodcoind, or the -server option to Kodcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> Kodcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:7857/\n";
}
