...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Kodcoin Core Kodcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  Kodcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Kodcoin transaction") + "\n" +
                               "  Kodcoin-tx [options] -create [commands]   " + _("Create hex-encoded Kodcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Kodcoin transaction
