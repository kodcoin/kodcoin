                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Kodcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Kodcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Kodcoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zKOD"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Kodcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Kodcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Kodcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Kodcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Kodcoin addresses"));
    ...
    openInfoAction->setStatusTip(tr("Show diagKodcointic information"));
    ...
    openAction->setStatusTip(tr("Open a Kodcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Kodcoin Core help message to get a list with possible Kodcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Kodcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Kodcoin network", "", count));
}
...
{
    QString strTitle = tr("Kodcoin Core"); // default title
...
/** Creates context menu, its actions, and Kodcoins up all the relevant signals for mouse events. */
