                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Kodcoin from zKodcoin"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zKodcoin"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zKodcoin));
