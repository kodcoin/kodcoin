...
/** Utility functions used by the Kodcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Kodcoin addresses in moKodcoinpace font
...
// Parse "Kodcoin:" URI into recipient object, return true on successful parsing
